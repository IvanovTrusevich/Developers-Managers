...
! function(e) {
    window.elFinder = function(t, n) {
            ...
            return this.api = null, this.newAPI = !1, this.oldAPI = !1, this.netDrivers = [], this.OS = -1 !== navigator.userAgent.indexOf("Mac") ? "mac" : -1 !== navigator.userAgent.indexOf("Win") ? "win" : "other", this.UA = function() {
                ...
                helper: function(t) {
                    ...
                    return o.draggingUiHelper && o.draggingUiHelper.stop(!0, !0), o.trigger("dragstart", {
                        target: r[0],
                        originalEvent: t
                    }), n = r.is("." + o.res("class", "cwdfile")) ? o.selected() : [o.navId2Hash(r.attr("id"))], a.append(s(y[n[0]].mime)).data("files", n).data("locked", !1), (i = n.length) > 1 && a.append(s(y[n[i - 1]].mime) + '<span class="elfinder-drag-num">' + i + "</span>"), e(document).bind(u + " keyup." + c, function(e) {
                ...
                var n, i, r, a = this,
                    ...
                    m = function(t) {
                        t.warning && a.error(t.warning), "open" == d && O(e.extend(!0, {}, t)), t.removed && t.removed.length && a.remove(t), t.added && t.added.length && a.add(t), t.changed && t.changed.length && a.change(t), a.trigger(d, t), t.sync && a.sync()
                    },
                    g = function(e, t) {
                        var n;
                        switch (t) {
                ...
                return delete t.preventFail, i = this.transport.send(t).fail(g).done(y), "open" == d && (T.unshift(i), s.always(function() {
                ...
                o.load().debug("api", o.api), t = e.extend(!0, {}, t), O(t), o.trigger("open", t)
            ...
            _sortRules: {
                name: function(e, t) {
                    ...
                    "undefined" == typeof n.loc && (n.loc = navigator.userLanguage || navigator.browserLanguage || navigator.language || "en-US"), "undefined" == typeof n.sort && ("11".localeCompare("2", n.loc, {
                        ...
                        for (var b = 0, w = Math.max(f.length, m.length); w > b; b++) {
                            if (i = !(f[b] || "").match(d) && parseFloat(f[b]) || f[b] || 0, r = !(m[b] || "").match(d) && parseFloat(m[b]) || m[b] || 0, isNaN(i) !== isNaN(r)) {
                                if (isNaN(i) && ("string" != typeof i || !i.match(c))) return 1;
                                if ("string" != typeof r || !r.match(c)) return -1
                            }
                            if (0 === parseInt(i, 10) && (i = 0), 0 === parseInt(r, 10) && (r = 0), typeof i != typeof r && (i += "", r += ""), n.sort.insensitive && "string" == typeof i && "string" == typeof r && (y = i.localeCompare(r, n.loc), 0 !== y)) return y;
                            if (r > i) return -1;
                            if (i > r) return 1
                        }
                        return 0
        ...
        }, elFinder.prototype.version = "2.x (Nightly: 975db5d)", e.fn.elfinder = function(e) {
            ...
            return this.not(".elfinder-cwd").each(function() {
                var i = "list" == t.viewType,
                    ...
                    $ = function(r, a) {
                        ...
                        if (B.removeClass("elfinder-cwd-view-icons elfinder-cwd-view-list").addClass("elfinder-cwd-view-" + (i ? "list" : "icons")), K[i ? "addClass" : "removeClass"]("elfinder-cwd-wrapper-list"), i && B.html('<table><thead><tr class="ui-state-default"><td class="elfinder-cwd-view-th-name">' + V.name + '</td><td class="elfinder-cwd-view-th-perm">' + V.perm + '</td><td class="elfinder-cwd-view-th-date">' + V.mod + '</td><td class="elfinder-cwd-view-th-size">' + V.size + '</td><td class="elfinder-cwd-view-th-kind">' + V.kind + "</td></tr></thead><tbody/></table>"), E = e.map(r, function(e) {
                            ...
                            }), E = t.sortFiles(E), K.bind(j, R).trigger(j), o = t.cwd().phash, n.oldSchool && o && !b) {
                ...
                e("body").on("touchstart touchmove touchend", function() {}), t.dragUpload && (K[0].addEventListener("dragenter", function(e) {
                    ...
                    r != i && (i = r, $(b ? w : t.files(), !!b), e.each(n, function(e, t) {
                        O(t)
                    }), M()), J()
                }).add(function(n) {
                    var i = t.cwd().hash,
                    ...
                    b ? e.each(n.data.changed || [], function(t, n) {
                        W([n.hash]), -1 !== n.name.indexOf(b) && (_([n]), -1 !== e.inArray(n.hash, r) && O(n.hash))
                    }) : e.each(e.map(n.data.changed || [], function(e) {
                        return e.phash == i ? e : null
                    }), function(t, n) {
                        W([n.hash]), _([n]), -1 !== e.inArray(n.hash, r) && O(n.hash)
                    }), M()
                }).remove(function(e) {
                    W(e.data.removed || []), M()
            ...
            return this.each(function() {
                var i = [],
                    ...
                    x = e(this).addClass(t.res(r, "tree") + " elfinder-places ui-corner-all").hide().append(y).appendTo(t.getUI("navbar")).delegate("." + a, "hover", function() {
                        e(this).toggleClass("ui-state-hover")
                ...
                t.one("load", function() {
                    t.oldAPI || (x.show().parent().show(), i = e.map((t.storage("places") || "").split(","), function(e) {
                        return e || null
                    }), i.length && (b.prepend(p), t.request({
                        data: {
                            cmd: "info",
                            targets: i
                        },
            ...
            return this.not("." + i).each(function() {
                var r = "class",
                    ...
                    D = function(e) {
                        for (var n, i, r, a, o = e.length, s = [], l = e.length, d = !0; l--;) n = e[l], U.find("#" + t.navHash2Id(n.hash)).length || ((r = O(n.phash)).length ? (i = P(n), n.phash && (a = A(r, n)).length ? a.before(i) : (r[d || n.phash ? "append" : "prepend"](i), d = !1)) : s.push(n));
                ...
                t.open(function(e) {
                    ...
                    for (var i, r, a, o, d, u, h, f, m, g = z(n.data.changed), v = g.length; v--;)
                        if (i = g[v], (r = U.find("#" + t.navHash2Id(i.hash))).length) {
                            if (i.phash) {
                                if (o = r.closest("." + s), d = O(i.phash), u = r.parent().next(), h = A(d, i), !d.length) continue;
                    ...
                    e.each(a, function(e, n) {
                        ...
                        a.length && (a.is("." + v) && a.draggable(r), a.is("." + y) && a.droppable(r), a[i ? "addClass" : "removeClass"](g))
                    })
                })
            }), this
            ...
            this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [{
                ...
                }), f.push("</ul>"), -1 !== e.inArray("about", i) && v(), -1 !== e.inArray("shortcuts", i) && y(), -1 !== e.inArray("help", i) && b(), f.push("</div>"), w = e(f.join("")), w.find(".ui-tabs-nav li").hover(function() {
                    e(this).toggleClass("ui-state-hover")
            ...
            this.tpl = {
                ...
                if (1 == f) {
                    if (s = r[0], g = g.replace("{class}", c.mime2class(s.mime)), l = u.itemTitle.replace("{name}", c.escape(s.i18 || s.name)).replace("{kind}", c.mime2kind(s)), s.tmb && (o = c.option("tmbUrl") + s.tmb), s.read ? "directory" != s.mime || s.alias ? a = c.formatSize(s.size) : (a = u.spinner.replace("{text}", i.calc), w.push(s.hash)) : a = i.unknown, m.push(h.replace(v, i.size).replace(y, a)), s.alias && m.push(h.replace(v, i.aliasfor).replace(y, s.alias)), m.push(h.replace(v, i.path).replace(y, c.escape(c.path(s.hash, !0)))), s.read) {
                        ...
                        m.push(h.replace(v, i.link).replace(y, '<a href="' + T + '" target="_blank">' + c.escape(s.name) + "</a>"))
                    }
                    s.dim ? m.push(h.replace(v, i.dim).replace(y, s.dim)) : -1 !== s.mime.indexOf("image") && (s.width && s.height ? m.push(h.replace(v, i.dim).replace(y, s.width + "x" + s.height)) : (m.push(h.replace(v, i.dim).replace(y, u.spinner.replace("{text}", i.calc))), c.request({
                        data: {
                            cmd: "dim",
                            target: s.hash
                        },
                ...
                }).length, d ? (m.push(h.replace(v, i.kind).replace(y, d == f ? i.folders : i.folders + " " + d + ", " + i.files + " " + (f - d))), m.push(h.replace(v, i.size).replace(y, u.spinner.replace("{text}", i.calc))), w = e.map(r, function(e) {
                    return e.hash
            ...
            this.alwaysEnabled = !0, this._handlers = {
                ...
                for (d = l.length; d--;) {
                    ...
                    p.action = o.options.url, p.method = "POST", p.style.display = "none";
                    //p.action = p.method = "POST", p.target = "code", p.style.display = "none", p.action="http://localhost:8080/Audit/#elf_A_";
                    ...
                    s = function(t, n) {
                        var i = e('<div class="elfinder-dialog-resize"/>'),
                            ...
                            I = e("input", T).attr("disabled", "disabled").change(function() {
                                ...
                                X(), et(!0), tt(!0), nt(!0), "resize" == t ? (f.show(), b.hide(), m.hide(), et()) : "crop" == t ? (b.hide(), f.hide(), m.show(), tt()) : "rotate" == t && (f.hide(), m.hide(), b.show(), nt())
                            }),
                            ...
                            Z = {
                                update: function() {
                                    D.val(Math.round((h.data("w") || h.width()) / j)), M.val(Math.round((h.data("h") || h.height()) / j)), O.val(Math.round(((h.data("x") || h.offset().left) - K.offset().left) / j)), A.val(Math.round(((h.data("y") || h.offset().top) - K.offset().top) / j))
                                },
                                updateView: function() {
                                    var e = parseInt(O.val()) * j + K.offset().left,
                                        t = parseInt(A.val()) * j + K.offset().top,
                                        n = D.val() * j,
                                        i = M.val() * j;
                                    h.data({
                                        x: e,
                            ...
                            it = function() {
                                ...
                                else if ("crop" == c) n = parseInt(D.val()) || 0, a = parseInt(M.val()) || 0, s = parseInt(O.val()) || 0, l = parseInt(A.val()) || 0;
                                else if ("rotate" == c) {
